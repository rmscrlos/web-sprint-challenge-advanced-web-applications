...
1.  Explain what a token is used for.
    -Token is a key used to give users access to application after being authenticated.

2.  What steps can you take in your web apps to keep your data secure?
    -By creating private routes, JWT tokens and authenticating users.

3.  Describe how web servers work.
    -A web server is what holds a database and other resources. It provides a specific interface to front-end apps to be able to communicate with those resources.
